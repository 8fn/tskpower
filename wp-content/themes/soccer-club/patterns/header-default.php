...
<div class="wp-block-group top-table-header has-accent-background-color has-background" style="padding-top:var(--wp--preset--spacing--40);padding-right:0;padding-bottom:var(--wp--preset--spacing--40);padding-left:0"><!-- wp:columns {"verticalAlignment":"center","textColor":"background"} -->
<div class="wp-block-columns are-vertically-aligned-center has-background-color has-text-color"><!-- wp:column {"verticalAlignment":"center","width":"25%","className":"header-phone"} -->
...
<p class="has-text-align-left has-abel-font-family has-upper-heading-font-size"><span class="dashicons dashicons-email-alt"></span>    '. esc_html('support123@example.com','soccer-club') .'</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
...
<div class="wp-block-group mainheader"><!-- wp:columns {"verticalAlignment":"center","style":{"spacing":{"padding":{"top":"var:preset|spacing|30","bottom":"var:preset|spacing|30","left":"var:preset|spacing|50","right":"var:preset|spacing|50"}},"border":{"radius":"30px"}},"className":"menu-table-block"} -->
<div class="wp-block-columns are-vertically-aligned-center menu-table-block" style="border-radius:30px;padding-top:var(--wp--preset--spacing--30);padding-right:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--30);padding-left:var(--wp--preset--spacing--50)"><!-- wp:column {"verticalAlignment":"center","width":"37.5%","className":"right-nav"} -->
<div class="wp-block-column is-vertically-aligned-center right-nav" style="flex-basis:37.5%"><!-- wp:navigation {"layout":{"type":"flex","justifyContent":"right"},"fontFamily":"teko"} -->
...
<div class="wp-block-column is-vertically-aligned-center left-nav" style="flex-basis:37.5%"><!-- wp:navigation {"layout":{"type":"flex","justifyContent":"right"},"fontFamily":"teko"} -->
